                ...
                <main flex-column col="3">
                    ...
                    <div class="secure__detail" col="4" flex>
                        <Card col="3" title="区域完工统计">
                            <doublebar-chart :data="qywgData" :count="count" :qymc="qymc" @handleChooseBar="handleChooseBar"></doublebar-chart>
                        </Card>
                    </div>
                </main>
                <!-- 右侧表格 -->
        ...
        queryProjectCompletionPanel(qymc){
             this.$get(this.API.queryProjectCompletionPanel,{
                ...
                if(res.data.state == 'success'){
                    ...
                    this.pie1Value[1].value = (Number(res.data.data.dnwgmb)-Number(res.data.data.dnwgwcl)) < 0 ? 0 : Number(res.data.data.dnwgmb)-Number(res.data.data.dnwgwcl)
                    this.pie1Value[0].value = res.data.data.dnwgwcl
                    
                    this.pie2Value[1].value = Number(res.data.data.bywgjh)-Number(res.data.data.bywgwcl) < 0 ? 0 : Number(res.data.data.bywgjh)-Number(res.data.data.bywgwcl)
                    this.pie2Value[0].value = res.data.data.bywgwcl

                    this.pie3Value[1].value = Number(res.data.data.wnwgmb)-Number(res.data.data.wnwgwcl) < 0 ? 0 : Number(res.data.data.wnwgmb)-Number(res.data.data.wnwgwcl)
                    this.pie3Value[0].value = res.data.data.wnwgwcl

                    this.pie4Value[1].value = Number(res.data.data.bywnwgjh)-Number(res.data.data.bywnwgwcl) < 0 ? 0 : Number(res.data.data.bywnwgjh)-Number(res.data.data.bywnwgwcl)
